...
- Known unrelated dirty/untracked items at handoff:
  - modified `README.md`
  - untracked `agent-trials/`, `codex-Codex-install-tutorial-v3.mp4`, `codex-clawbot-bridge/`, `depcheck-grade-fixture*/`, `portfolio-app/`, `video-projects/`
...
cd "E:\PROJECT FROM CODEX"
git status --short
git add app.py src tests config.json portfolio.json requirements.txt AGENTS.md DEPLOY.md
